...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                "function": "__html",
                "vtp_html": "\n\u003Cscript nonce=\"3G31ORXU\" type=\"text\/gtmscript\"\u003E!function(b,e,f,g,a,c,d){b.fbq||(a=b.fbq=function(){a.callMethod?a.callMethod.apply(a,arguments):a.queue.push(arguments)},b._fbq||(b._fbq=a),a.push=a,a.loaded=!0,a.version=\"2.0\",a.queue=[],c=e.createElement(f),c.async=!0,c.src=g,d=e.getElementsByTagName(f)[0],d.parentNode.insertBefore(c,d))}(window,document,\"script\",\"https:\/\/connect.facebook.net\/en_US\/fbevents.js\");fbq(\"init\",\"832383167876613\");fbq(\"set\",\"agent\",\"tmgoogletagmanager\",\"832383167876613\");fbq(\"track\",\"PageView\");\u003C\/script\u003E\n\u003Cnoscript\u003E\u003Cimg height=\"1\" width=\"1\" style=\"display:none\" src=\"https:\/\/www.facebook.com\/tr?id=832383167876613\u0026amp;ev=PageView\u0026amp;noscript=1\"\u003E\u003C\/noscript\u003E\n",
    ...
    */
    ...
    Ce.vd = Number("0") || 0;
    Ce.da = "dataLayer";
    Ce.Mm = "ChEIgJaGrwYQvpems7z566H+ARIkADE9Y2I5iNXj9eFAwoilM8053b67jTvsGdH6WlFQGR2gbDk8GgJtsQ\x3d\x3d";
    var Fe = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    var pf;
    try {
        pf = JSON.parse(eb("eyIwIjoiR0IiLCIxIjoiR0ItRU5HIiwiMiI6ZmFsc2UsIjMiOiJnb29nbGUuY28udWsiLCI0IjoicmVnaW9uMSIsIjUiOmZhbHNlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
    } catch (a) {
        K(123), of (2), pf = {}
    }
    var qf = function() {
    ...
    function To(a) {
        var b = [];
        var c = a.Za;
        void 0 !== So && (b.push(["ual", Math.floor(So)]), c && (So = void 0));
        return b
    };
    Bb();
    Fi() || yb("iPod");
    ...
    var ov = new nv;
    var qv = function() {
            (De.rm = De.rm || {})[fg()] = function(a) {
                if (pv.hasOwnProperty(a)) return pv[a]
            }
        },
        tv = function(a, b, c) {
            if (a instanceof rv) {
        ...
        rv = function(a) {
            this.h = function(b) {
                for (var c = [], d = 0; d < a.length; d++) c.push(a[d] === ov ? b : a[d]);
                return c.join("")
            }
        };
    ...
    rv.prototype.valueOf = rv.prototype.toString;
    var pv = {},
        sv = {};
            ...
            function b(d) {
                if (G.body) {
                    var e = d.vtp_gtmOnFailure,
                        f = tv(d.vtp_html, d.vtp_gtmOnSuccess, e),
                        h = f.Al,
                        l = f.onSuccess;
                    if (d.vtp_useIframe) {} else d.vtp_supportDocumentWrite ? c(h, l, e) : a(G.body, ec(h), l, e)()
                } else Uv(function() {
                    b(d)
                }, 200)
            }
    ...
    var pB = {};
    pB.onHtmlSuccess = uv(!0), pB.onHtmlFailure = uv(!1);
    pB.dataLayer = df;
