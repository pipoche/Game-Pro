! function(e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).mqtt = e()
}((function() {
    return function e(t, r, n) {
        ...
        1: [function(e, t, r) {
            (function(r, n) {
                ...
                function y(e, t, r) {
                    h("sendPacket :: packet: %O", t), h("sendPacket :: emitting `packetsend`"), e.emit("packetsend", t), h("sendPacket :: writing to stream");
                    var n = s.writeToStream(t, e.stream, e.options);
                    h("sendPacket :: writeToStream result %s", n), !n && r ? (h("sendPacket :: handle events on `drain` once through callback."), e.stream.once("drain", r)) : r && (h("sendPacket :: invoking cb"), r())
                }
                ...
                function v(e, t) {
                    ...
                    h("MqttClient :: options.protocol", t.protocol), h("MqttClient :: options.protocolVersion", t.protocolVersion), h("MqttClient :: options.username", t.username), h("MqttClient :: options.keepalive", t.keepalive), h("MqttClient :: options.reconnectPeriod", t.reconnectPeriod), h("MqttClient :: options.rejectUnauthorized", t.rejectUnauthorized), this.options.clientId = "string" == typeof t.clientId ? t.clientId : "mqttjs_" + Math.random().toString(16).substr(2, 8), h("MqttClient :: clientId", this.options.clientId), this.options.customHandleAcks = 5 === t.protocolVersion && t.customHandleAcks ? t.customHandleAcks : function() {
                        ...
                        h("connect :: sending queued packets"),
                            function t() {
                                var r, i = e.shift();
                                h("deliver :: entry %o", i), i && (r = i.packet, h("deliver :: call _sendPacket for %o", r), n._sendPacket(r, (function(e) {
                                    i.cb && i.cb(e), t()
                                })))
                            }()
                    })), this.on("close", (function() {
                        h("close :: connected set to `false`"), this.connected = !1, h("close :: clearing connackTimer"), clearTimeout(this.connackTimer), h("close :: clearing ping timer"), null !== n.pingTimer && (n.pingTimer.clear(), n.pingTimer = null), h("close :: calling _setupReconnect"), this._setupReconnect()
                ...
                u(v, i), v.prototype._setupStream = function() {
                    ...
                    function c() {
                        ...
                        var e = o.shift();
                        if (e) h("work :: packet pulled from queue"), t._handlePacket(e, u);
                        else {
                            h("work :: no packets in queue");
                            var r = i;
                            i = null, h("work :: done flag is %s", !!r), r && r()
                        }
                    }
                    if (h("_setupStream :: calling method to clear reconnect"), this._clearReconnect(), h("_setupStream :: using streamBuilder provided to client to create stream"), this.stream = this.streamBuilder(this), n.on("packet", (function(e) {
                            h("parser :: on packet push to packets array."), o.push(e)
                        })), r._write = function(e, t, r) {
                            i = r, h("writable stream :: parsing buffer"), n.parse(e), c()
                        }, h("_setupStream :: pipe stream to writable stream"), this.stream.pipe(r), this.stream.on("error", (function(e) {
                            h("streamErrorHandler :: error", e.message), b.includes(e.code) ? (h("streamErrorHandler :: emitting error"), t.emit("error", e)) : w(e)
                        })), this.stream.on("close", (function() {
                            var e;
                            h("(%s)stream :: on close", t.options.clientId), (e = t.outgoing) && (h("flushVolatile :: deleting volatile messages from the queue and setting their callbacks as error function"), Object.keys(e).forEach((function(t) {
                                e[t].volatile && "function" == typeof e[t].cb && (e[t].cb(new Error("Connection closed")), delete e[t])
                            }))), h("stream: emit close to MqttClient"), t.emit("close")
                        })), h("_setupStream: sending packet `connect`"), (e = Object.create(this.options)).cmd = "connect", y(this, e), n.on("error", this.emit.bind(this, "error")), this.options.properties) {
                        ...
                        this.options.properties.authenticationMethod && this.options.authPacket && "object" == typeof this.options.authPacket && y(this, f({
                            cmd: "auth",
                            reasonCode: 0
                        }, this.options.authPacket))
                    }
                    this.stream.setMaxListeners(1e3), clearTimeout(this.connackTimer), this.connackTimer = setTimeout((function() {
                        h("!!connectTimeout hit!! Calling _cleanUp with force `true`"), t._cleanUp(!0)
                    ...
                    switch (h("_handlePacket :: emitting packetreceive"), this.emit("packetreceive", e), e.cmd) {
                        case "publish":
                    ...
                    var o = this.options;
                    if ("function" == typeof r && (n = r, r = null), r = f({
                            qos: 0,
                            retain: !1,
                            dup: !1
                    ...
                    switch (i = {
                        ...
                        dup: r.dup
                    }, 5 === o.protocolVersion && (i.properties = r.properties, (!o.properties && i.properties && i.properties.topicAlias || r.properties && o.properties && (r.properties.topicAlias && o.properties.topicAliasMaximum && r.properties.topicAlias > o.properties.topicAliasMaximum || !o.properties.topicAliasMaximum && r.properties.topicAlias)) && delete i.properties.topicAlias), h("publish :: qos", r.qos), r.qos) {
                        case 1:
                        case 2:
                            this.outgoing[i.messageId] = {
                                volatile: !1,
                                cb: n || w
                            }, this._storeProcessing ? (h("_storeProcessing enabled"), this._packetIdsDuringStoreProcessing[i.messageId] = !1, this._storePacket(i, void 0, r.cbStorePut)) : (h("MqttClient:publish: packet cmd: %s", i.cmd), this._sendPacket(i, void 0, r.cbStorePut));
                            break;
                        default:
                            this._storeProcessing ? (h("_storeProcessing enabled"), this._storePacket(i, n, r.cbStorePut)) : (h("MqttClient:publish: packet cmd: %s", i.cmd), this._sendPacket(i, n, r.cbStorePut))
                    }
                    return this
                    ...
                    if (delete o.resubscribe, "string" == typeof o && (o = [o]), "function" != typeof a && (u = a, a = w), null !== (n = l.validateTopics(o))) return d(a, new Error("Invalid topic " + n)), this;
                    if (this._checkDisconnecting(a)) return h("subscribe: discconecting true"), this;
                    var g = {
                        qos: 0
                    };
                    if (5 === p && (g.nl = !1, g.rap = !1, g.rh = 0), u = f(g, u), Array.isArray(o) ? o.forEach((function(e) {
                            if (h("subscribe: array topic %s", e), !c._resubscribeTopics.hasOwnProperty(e) || c._resubscribeTopics[e].qos < u.qos || s) {
                                var t = {
                                    topic: e,
                                    qos: u.qos
                                };
                                5 === p && (t.nl = u.nl, t.rap = u.rap, t.rh = u.rh, t.properties = u.properties), h("subscribe: pushing topic `%s` and qos `%s` to subs list", t.topic, t.qos), i.push(t)
                            }
                        })) : Object.keys(o).forEach((function(e) {
                            if (h("subscribe: object topic %s", e), !c._resubscribeTopics.hasOwnProperty(e) || c._resubscribeTopics[e].qos < o[e].qos || s) {
                                var t = {
                                    topic: e,
                                    qos: o[e].qos
                                };
                                5 === p && (t.nl = o[e].nl, t.rap = o[e].rap, t.rh = o[e].rh, t.properties = u.properties), h("subscribe: pushing `%s` to subs list", t), i.push(t)
                            }
                        })), e = {
                            cmd: "subscribe",
                            subscriptions: i,
                        ...
                        if (this.options.resubscribe) {
                            ...
                            i.forEach((function(e) {
                                if (c.options.reconnectPeriod > 0) {
                                    ...
                                    5 === p && (t.nl = e.nl || !1, t.rap = e.rap || !1, t.rh = e.rh || 0, t.properties = e.properties), c._resubscribeTopics[e.topic] = t, b.push(e.topic)
                                }
                    ...
                    function i() {
                        h("end :: (%s) :: finish :: calling _cleanUp with force %s", n.options.clientId, e), n._cleanUp(e, (() => {
                            h("end :: finish :: calling process.nextTick on closeStores"), p(function() {
                                h("end :: closeStores: closing incoming and outgoing stores"), n.disconnected = !0, n.incomingStore.close((function(e) {
                                    n.outgoingStore.close((function(t) {
                                        if (h("end :: closeStores: emitting end"), n.emit("end"), r) {
                                            let n = e || t;
                                            h("end :: closeStores: invoking callback with args"), r(n)
                                        }
                                    }))
                    ...
                    var e = this;
                    !e.disconnecting && !e.reconnectTimer && e.options.reconnectPeriod > 0 ? (this.reconnecting || (h("_setupReconnect :: emit `offline` state"), this.emit("offline"), h("_setupReconnect :: set `reconnecting` to `true`"), this.reconnecting = !0), h("_setupReconnect :: setting reconnectTimer for %d ms", e.options.reconnectPeriod), e.reconnectTimer = setInterval((function() {
                    ...
                    var r, n = arguments[2];
                    if (t && (h("_cleanUp :: done callback provided for on stream close"), this.stream.on("close", t)), h("_cleanUp :: forced? %s", e), e) 0 === this.options.reconnectPeriod && this.options.clean && (r = this.outgoing) && (h("flush: queue exists? %b", !!r), Object.keys(r).forEach((function(e) {
                        ...
                        h("_cleanUp :: (%s) :: call _sendPacket with disconnect packet", this.options.clientId), this._sendPacket(i, d.bind(null, this.stream.end.bind(this.stream)))
                    }
                    ...
                    if (h("_sendPacket :: (%s) ::  start", this.options.clientId), r = r || w, !this.connected) return h("_sendPacket :: client not connected. Storing packet offline."), void this._storePacket(e, t, r);
                    ...
                    h("_storePacket :: packet: %o", e), h("_storePacket :: cb? %s", !!t), r = r || w, 0 === (e.qos || 0) && this.queueQoSZero || "publish" !== e.cmd ? this.queue.push({
                        packet: e,
                        cb: t
                    ...
                    h("_checkPing :: checking ping..."), this.pingResp ? (h("_checkPing :: ping response received. Clearing flag and sending `pingreq`"), this.pingResp = !1, this._sendPacket({
                        cmd: "pingreq"
        ...
        5: [function(e, t, r) {
            (function(r, n) {
                ...
                const c = void 0 !== r && "browser" === r.title || "function" == typeof __webpack_require__;
                ...
                function f(e) {
                    let t = e;
                    return e.hostname || (t.hostname = "localhost"), e.port || ("wss" === e.protocol ? t.port = 443 : t.port = 80), e.path || (t.path = "/"), e.wsOptions || (t.wsOptions = {}), c || "wss" !== e.protocol || u.forEach((function(r) {
                ...
                t.exports = c ? function(e, t) {
                    ...
                    let h = function(e, t) {
                        ...
                        p = function(e, t, r) {
                            ...
                            h.bufferedAmount > i && setTimeout(e, u, t, r, o), c && "string" == typeof t && (t = n.from(t, "utf8"));
                            try {
                                h.send(t)
                            } catch (e) {
                                return o(e)
                    ...
                    const d = void 0 === h.addEventListener;
                    ...
                    return h.readyState === h.OPEN ? r = p : (r = r = s(void 0, void 0, t), t.objectMode || (r._writev = _), d ? h.addEventListener("open", g) : h.onopen = g), r.socket = h, d ? (h.addEventListener("close", b), h.addEventListener("error", m), h.addEventListener("message", y)) : (h.onclose = b, h.onerror = m, h.onmessage = y), r
                } : function(e, t) {
                    o("streamBuilder");
                    let r = f(t);
                    const n = l(r, e);
        ...
        9: [function(e, t, r) {
            (function(r) {
                ...
                void 0 !== r && "browser" !== r.title || "function" != typeof __webpack_require__ ? (u.mqtt = e("./tcp"), u.tcp = e("./tcp"), u.ssl = e("./tls"), u.tls = e("./tls"), u.mqtts = e("./tls")) : (u.wx = e("./wx"), u.wxs = e("./wx"), u.ali = e("./ali"), u.alis = e("./ali")), u.ws = e("./ws"), u.wss = e("./ws"), t.exports = c, t.exports.connect = c, t.exports.MqttClient = n, t.exports.Store = i
            ...
            (function(t) {
                ...
                function a(e, r, n) {
                    ...
                    var o = function(e) {
                        ...
                        return void 0 !== e.length ? "number" != typeof e.length || D(e.length) ? s(0) : l(e) : "Buffer" === e.type && Array.isArray(e.data) ? l(e.data) : void 0
                    }(e);
                    if (o) return o;
                ...
                r.kMaxLength = o, t.TYPED_ARRAY_SUPPORT = function() {
                    ...
                    if (r >= n) return 1;
                    if (this === e) return 0;
                    for (var s = (o >>>= 0) - (i >>>= 0), a = (n >>>= 0) - (r >>>= 0), u = Math.min(s, a), c = this.slice(i, o), l = e.slice(r, n), f = 0; f < u; ++f)
                        if (c[f] !== l[f]) {
                            s = c[f], a = l[f];
                            break
                        }
        ...
        19: [function(e, t, r) {
            (function(r, n) {
                ...
                t.exports = _;
                var o, s = e("isarray");
                _.ReadableState = y, e("events").EventEmitter;
                var a = function(e, t) {
                ...
                function _(t) {
                    ...
                    this._readableState = new y(t, this), this.readable = !0, t && ("function" == typeof t.read && (this._read = t.read), "function" == typeof t.destroy && (this._destroy = t.destroy)), u.call(this)
                }
                ...
                function w(e, t, r, n, i) {
                    ...
                    return null === t ? (s.reading = !1, function(e, t) {
                            ...
                            var r, n;
                            return n = t, c.isBuffer(n) || n instanceof l || "string" == typeof t || void 0 === t || e.objectMode || (r = new TypeError("Invalid non-string/buffer chunk")), r
                            ...
                            return c.from(e)
                        }(t)), n ? s.endEmitted ? e.emit("error", new Error("stream.unshift() after end event")) : v(e, s, t, !0) : s.ended ? e.emit("error", new Error("stream.push() after EOF")) : (s.reading = !1, s.decoder && !r ? (t = s.decoder.write(t), s.objectMode || 0 !== t.length ? v(e, s, t, !1) : C(e, s)) : v(e, s, t, !1))) : n || (s.reading = !1)),
                        function(e) {
                ...
                function v(e, t, r, n) {
                    t.flowing && 0 === t.length && !t.sync ? (e.emit("data", r), e.read(0)) : (t.length += t.objectMode ? 1 : r.length, n ? t.buffer.unshift(r) : t.buffer.push(r), t.needReadable && E(e)), C(e, t)
                }
                ...
                function I(e) {
                    p("emit readable"), e.emit("readable"), A(e)
                }
                ...
                function R(e, t) {
                    t.reading || (p("resume read 0"), e.read(0)), t.resumeScheduled = !1, t.awaitDrain = 0, e.emit("resume"), A(e), t.flowing && !t.reading && e.read(0)
                }
                ...
                _.prototype.read = function(e) {
                    ...
                    var t = this._readableState,
                        r = e;
                    if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && (t.length >= t.highWaterMark || t.ended)) return p("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? O(this) : E(this), null;
                    ...
                    var u = t && !1 === t.end || e === r.stdout || e === r.stderr ? y : c;

                    function c() {
                        p("onend"), e.end()
                    }
                    o.endEmitted ? i.nextTick(u) : n.once("end", u), e.on("unpipe", (function t(r, i) {
                        p("onunpipe"), r === n && i && !1 === i.hasUnpiped && (i.hasUnpiped = !0, p("cleanup"), e.removeListener("close", b), e.removeListener("finish", m), e.removeListener("drain", l), e.removeListener("error", g), e.removeListener("unpipe", t), n.removeListener("end", c), n.removeListener("end", y), n.removeListener("data", d), f = !0, !o.awaitDrain || e._writableState && !e._writableState.needDrain || l())
                    }));
                    var l = function(e) {
                        return function() {
                            var t = e._readableState;
                            p("pipeOnDrain", t.awaitDrain), t.awaitDrain && t.awaitDrain--, 0 === t.awaitDrain && a(e, "data") && (t.flowing = !0, A(e))
                        }
                    }(n);
                    e.on("drain", l);
                    var f = !1,
                    ...
                    function d(t) {
                        p("ondata"), h = !1, !1 !== e.write(t) || h || ((1 === o.pipesCount && o.pipes === e || o.pipesCount > 1 && -1 !== L(o.pipes, e)) && !f && (p("false write response, pause", n._readableState.awaitDrain), n._readableState.awaitDrain++, h = !0), n.pause())
                    }

                    function g(t) {
                        p("onerror", t), y(), e.removeListener("error", g), 0 === a(e, "error") && e.emit("error", t)
                    }
                    ...
                    return n.on("data", d),
                        ...
                        }(e, "error", g), e.once("close", b), e.once("finish", m), e.emit("pipe", n), o.flowing || (p("pipe resume"), n.resume()), e
                    ...
                    if ("data" === e) !1 !== this._readableState.flowing && this.resume();
                        ...
                        n.endEmitted || n.readableListening || (n.readableListening = n.needReadable = !0, n.emittedReadable = !1, n.reading ? n.length && E(this) : i.nextTick(x, this))
                    }
                    return r
        ...
        21: [function(e, t, r) {
            (function(r, n, i) {
                    ...
                    this.decodeStrings = !f, this.defaultEncoding = t.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function(e) {
                        ! function(e, t) {
                            ...
                            if (function(e) {
                                ...
                                var s = S(r);
                                s || r.corked || r.bufferProcessing || !r.bufferedRequest || v(e, r), n ? u(w, e, r, s, i) : w(e, r, s, i)
                            }
                        }(r, e)
                ...
                function y(t) {
                    if (a = a || e("./_stream_duplex"), !(l.call(y, this) || this instanceof a)) return new y(t);
                    ...
                    if (e._writev && r && r.next) {
                        ...
                        for (; r;) {
                            var c = r.chunk,
                                l = r.encoding,
                                f = r.callback;
                            if (_(e, t, !1, t.objectMode ? 1 : c.length, c, l, f), r = r.next, t.bufferedRequestCount--, t.writing) break
                        }
                ...
                c.inherits(y, h), m.prototype.getBuffer = function() {
                    ...
                    function() {
                        ...
                        value: function(e) {
                            return !!l.call(this, e) || this === y && e && e._writableState instanceof m
                        }
                    })) : l = function(e) {
                ...
                var n = e("once"),
                    ...
                    o = function(e, t, s) {
                        ...
                        return function(e) {
                            ...
                            }(e) ? (e.on("complete", p), e.on("abort", m), e.req ? _() : e.on("request", _)) : l && !a && (e.on("end", h), e.on("close", h)),
                            function(e) {
                                return e.stdio && Array.isArray(e.stdio) && 3 === e.stdio.length
                            }(e) && e.on("exit", g), e.on("end", d), e.on("finish", p), !1 !== t.error && e.on("error", b), e.on("close", m),
                            function() {
                                f = !0, e.removeListener("complete", p), e.removeListener("abort", m), e.removeListener("request", _), e.req && e.req.removeListener("finish", p), e.removeListener("end", h), e.removeListener("close", h), e.removeListener("finish", p), e.removeListener("exit", g), e.removeListener("end", d), e.removeListener("error", b), e.removeListener("close", m)
                            }
                    };
                t.exports = o
            }).call(this, e("_process"))
                    ...
                    case 4:
                        ! function(e, t, r, n, i, o) {
                            if (t) e.call(r, n, i, o);
                                ...
                                for (var s = e.length, a = b(e, s), u = 0; u < s; ++u) a[u].call(r, n, i, o)
        ...
        28: [function(e, t, r) {
            r.read = function(e, t, r, n, i) {
                ...
                var s, a, u, c = 8 * o - i - 1,
                    ...
                    d = n ? 1 : -1,
                    g = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
                for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0, s = l) : (s = Math.floor(Math.log(t) / Math.LN2), t * (u = Math.pow(2, -s)) < 1 && (s--, u *= 2), (t += s + f >= 1 ? h / u : h * Math.pow(2, 1 - f)) * u >= 2 && (s++, u /= 2), s + f >= l ? (a = 0, s = l) : s + f >= 1 ? (a = (t * u - 1) * Math.pow(2, i), s += f) : (a = t * Math.pow(2, f - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + p] = 255 & a, p += d, a /= 256, i -= 8);
        ...
        32: [function(e, t, r) {
            (function(e) {
                ...
                r.CMD_SHIFT = 4, r.CMD_MASK = 240, r.DUP_MASK = 8, r.QOS_MASK = 3, r.QOS_SHIFT = 1, r.RETAIN_MASK = 1, r.VARBYTEINT_MASK = 127, r.VARBYTEINT_FIN_MASK = 128, r.SESSIONPRESENT_MASK = 1, r.SESSIONPRESENT_HEADER = e.from([r.SESSIONPRESENT_MASK]), r.CONNACK_HEADER = e.from([r.codes.connack << r.CMD_SHIFT]), r.USERNAME_MASK = 128, r.PASSWORD_MASK = 64, r.WILL_RETAIN_MASK = 32, r.WILL_QOS_MASK = 24, r.WILL_QOS_SHIFT = 3, r.WILL_FLAG_MASK = 4, r.CLEAN_SESSION_MASK = 2, r.CONNECT_HEADER = e.from([r.codes.connect << r.CMD_SHIFT]), r.properties = {
                ...
                r.propertiesTypes = {
                    ...
                    pubrel: n("pubrel"),
                    pubrec: n("pubrec")
                }, r.SUBACK_HEADER = e.from([r.codes.suback << r.CMD_SHIFT]), r.VERSION3 = e.from([3]), r.VERSION4 = e.from([4]), r.VERSION5 = e.from([5]), r.QOS = [0, 1, 2].map((t => e.from([t]))), r.EMPTY = {
        ...
        35: [function(e, t, r) {
            ...
            const {
                Buffer: n
            } = e("buffer"), i = Symbol.for("BufferList");
            ...
            o._init = function(e) {
                    ...
                    for (let t = s[0]; t < this._bufs.length; t++) {
                        ...
                        if (!(u > r)) {
                            this._bufs[t].copy(e, c, l, l + u), c += r;
                            break
                        }
                        this._bufs[t].copy(e, c, l), c += r, u -= r, l && (l = 0)
                    }
        ...
        37: [function(e, t, r) {
            (function(e) {
                const r = {},
                    n = e.isBuffer(e.from([1, 2]).subarray(0, 1));
        ...
        39: [function(e, t, r) {
            ...
            class u extends i {
                ...
                _parseLength() {
                    ...
                    return e ? (this.packet.length = e.value, this._list.consume(e.bytes)) : this._emitError(new Error("Invalid length")), a("_parseLength %d", e.value), !!e
                }
                _parsePayload() {
                ...
                _parseConnect() {
                    ...
                    const c = this._parseString();
                    if (null === c) return this._emitError(new Error("Packet too short"));
                    if (o.clientId = c, a("_parseConnect: packet.clientId: %s", o.clientId), i.will) {
                        if (5 === o.protocolVersion) {
                            const e = this._parseProperties();
                ...
                _parseConnack() {
                    ...
                    if (e.sessionPresent = !!(this._list.readUInt8(this._pos++) & s.SESSIONPRESENT_MASK), 5 === this.settings.protocolVersion ? e.reasonCode = this._list.readUInt8(this._pos++) : e.returnCode = this._list.readUInt8(this._pos++), -1 === e.returnCode || -1 === e.reasonCode) return this._emitError(new Error("Cannot parse return code"));
                ...
                _parseSubscribe() {
                    ...
                    if (e.subscriptions = [], this._parseMessageId()) {
                        ...
                        for (; this._pos < e.length;) {
                            ...
                            n = (r = this._parseByte()) & s.SUBSCRIBE_OPTIONS_QOS_MASK, u = 0 != (r >> s.SUBSCRIBE_OPTIONS_NL_SHIFT & s.SUBSCRIBE_OPTIONS_NL_MASK), o = 0 != (r >> s.SUBSCRIBE_OPTIONS_RAP_SHIFT & s.SUBSCRIBE_OPTIONS_RAP_MASK), i = r >> s.SUBSCRIBE_OPTIONS_RH_SHIFT & s.SUBSCRIBE_OPTIONS_RH_MASK, c = {
                                topic: t,
                                qos: n
                            }, 5 === this.settings.protocolVersion && (c.nl = u, c.rap = o, c.rh = i), a("_parseSubscribe: push subscription `%s` to subscription", c), e.subscriptions.push(c)
                        }
                    }
                }
                _parseSuback() {
                ...
                _parseConfirmation() {
                    ...
                    const e = this.packet;
                    if (this._parseMessageId(), 5 === this.settings.protocolVersion && (e.length > 2 && (e.reasonCode = this._parseByte(), a("_parseConfirmation: packet.reasonCode `%d`", e.reasonCode)), e.length > 3)) {
                        const t = this._parseProperties();
                        Object.getOwnPropertyNames(t).length && (e.properties = t)
                    }
                    return !0
                ...
                _parseVarByteNum(e) {
                    ...
                    return u && (this._pos += r), a("_parseVarByteNum: result: %o", o = !!o && (e ? {
                        bytes: r,
                        value: i
                    } : i)), o
                }
                _parseByte() {
                    const e = this._list.readUInt8(this._pos);
                    return this._pos++, a("_parseByte: result: %o", e), e
                }
                _parseByType(e) {
        ...
        40: [function(e, t, r) {
            (function(r) {
                ...
                function b(e, t, s) {
                    switch (u("generate called"), t.cork && (t.cork(), a(m, t)), g && (g = !1, f()), u("generate: packet.cmd: %s", e.cmd), e.cmd) {
                        case "connect":
                            return function(e, t, i) {
                                ...
                                if (b += s.length + 2, 3 !== a && 4 !== a && 5 !== a) return t.emit("error", new Error("Invalid protocol version")), !1;
                                if (b += 1, "string" != typeof f && !r.isBuffer(f) || !f && 4 !== a || !f && !c) {
                                ...
                                if (u) {
                                    if ("object" != typeof u) return t.emit("error", new Error("Invalid will")), !1;
                                    if (!u.topic || "string" != typeof u.topic) return t.emit("error", new Error("Invalid will topic")), !1;
                                    if (b += r.byteLength(u.topic) + 2, b += 2, u.payload) {
                                        if (!(u.payload.length >= 0)) return t.emit("error", new Error("Invalid will payload")), !1;
                                        "string" == typeof u.payload ? b += r.byteLength(u.payload) : b += u.payload.length
                                    }
                                    var y = {};
                                    if (5 === a) {
                                        if (!(y = I(t, u.properties))) return !1;
                                        b += y.length
                                    }
                                }
                                let v = !1;
                                if (null != h) {
                                    if (!A(h)) return t.emit("error", new Error("Invalid username")), !1;
                                    v = !0, b += r.byteLength(h) + 2
                                }
                                if (null != p) {
                                    if (!v) return t.emit("error", new Error("Username is required to use password")), !1;
                                    if (!A(p)) return t.emit("error", new Error("Invalid password")), !1;
                                    b += R(p) + 2
                                }
                                t.write(n.CONNECT_HEADER), _(t, b), E(t, s), t.write(4 === a ? n.VERSION4 : 5 === a ? n.VERSION5 : n.VERSION3);
                                let S = 0;
                                return S |= null != h ? n.USERNAME_MASK : 0, S |= null != p ? n.PASSWORD_MASK : 0, S |= u && u.retain ? n.WILL_RETAIN_MASK : 0, S |= u && u.qos ? u.qos << n.WILL_QOS_SHIFT : 0, S |= u ? n.WILL_FLAG_MASK : 0, S |= c ? n.CLEAN_SESSION_MASK : 0, t.write(r.from([S])), d(t, l), 5 === a && m.write(), E(t, f), u && (5 === a && y.write(), w(t, u.topic), E(t, u.payload)), null != h && E(t, h), null != p && E(t, p), !0
                            }(e, t);
                        case "connack":
                            return function(e, t, i) {
                                ...
                                return t.write(n.CONNACK_HEADER), _(t, l), t.write(a.sessionPresent ? n.SESSIONPRESENT_HEADER : o), t.write(r.from([u])), null != f && f.write(), !0
                            }(e, t, s);
                        case "publish":
                            return function(e, t, o) {
                                ...
                                const s = o ? o.protocolVersion : 4,
                                    ...
                                    g = a.properties;
                                let b = 0;
                                if ("string" == typeof f) b += r.byteLength(f) + 2;
                                else {
                                    if (!r.isBuffer(f)) return t.emit("error", new Error("Invalid topic")), !1;
                                    b += f.length + 2
                                }
                                if (r.isBuffer(h) ? b += h.length : b += r.byteLength(h), c && "number" != typeof p) return t.emit("error", new Error("Invalid messageId")), !1;
                                c && (b += 2);
                                let m = null;
                                if (5 === s) {
                                    if (!(m = I(t, g))) return !1;
                                ...
                                return t.write(n.PUBLISH_HEADER[c][a.dup ? 1 : 0][l ? 1 : 0]), _(t, b), d(t, R(f)), t.write(f), c > 0 && d(t, p), null != m && m.write(), u("publish: payload: %o", h), t.write(h)
                            }(e, t, s);
                        case "puback":
                        case "pubrec":
                        case "pubrel":
                        case "pubcomp":
                            return function(e, t, i) {
                                ...
                                if (5 === o && "object" == typeof h) {
                                    if (!(g = C(t, h, i, p))) return !1;
                                    p += g.length
                                }
                                return t.write(n.ACKS[a][l][c][0]), _(t, p), d(t, u), 5 === o && t.write(r.from([f])), null !== g && g.write(), !0
                            }(e, t, s);
                        case "subscribe":
                            return function(e, t, i) {
                                u("subscribe: packet: ");
                                ...
                                u("subscribe: writing to stream: %o", n.SUBSCRIBE_HEADER), t.write(n.SUBSCRIBE_HEADER[1][a ? 1 : 0][0]), _(t, h), d(t, c), null !== p && p.write();
                                let g = !0;
                                for (const e of l) {
                                    const i = e.topic,
                                        s = e.qos,
                                        ...
                                        c = e.rh;
                                    let l;
                                    w(t, i), l = n.SUBSCRIBE_OPTIONS_QOS[s], 5 === o && (l |= a ? n.SUBSCRIBE_OPTIONS_NL : 0, l |= u ? n.SUBSCRIBE_OPTIONS_RAP : 0, l |= c ? n.SUBSCRIBE_OPTIONS_RH[c] : 0), g = t.write(r.from([l]))
                                }
                                return g
                            }(e, t, s);
                        case "suback":
                            return function(e, t, i) {
                                ...
                                if (l += 2, "object" != typeof u || !u.length) return t.emit("error", new Error("Invalid qos vector")), !1;
                                ...
                                let f = null;
                                if (5 === o) {
                                    if (!(f = C(t, c, i, l))) return !1;
                                    l += f.length
                                }
                                return t.write(n.SUBACK_HEADER), _(t, l), d(t, a), null !== f && f.write(), t.write(r.from(u))
                            }(e, t, s);
                        case "unsubscribe":
                            return function(e, t, i) {
                                const o = i ? i.protocolVersion : 4,
                                ...
                                let f = 0;
                                if ("number" != typeof a) return t.emit("error", new Error("Invalid messageId")), !1;
                                if (f += 2, "object" != typeof c || !c.length) return t.emit("error", new Error("Invalid unsubscriptions")), !1;
                                for (let e = 0; e < c.length; e += 1) {
                                    if ("string" != typeof c[e]) return t.emit("error", new Error("Invalid unsubscriptions")), !1;
                                    f += r.byteLength(c[e]) + 2
                                }
                                let h = null;
                                if (5 === o) {
                                    if (!(h = I(t, l))) return !1;
                                ...
                                t.write(n.UNSUBSCRIBE_HEADER[1][u ? 1 : 0][0]), _(t, f), d(t, a), null !== h && h.write();
                                let p = !0;
                                for (let e = 0; e < c.length; e++) p = w(t, c[e]);
                                return p
                            }(e, t, s);
                        case "unsuback":
                            return function(e, t, i) {
                                ...
                                let p = null;
                                if (5 === o) {
                                    if (!(p = C(t, l, i, h))) return !1;
                                    h += p.length
                                }
                                return t.write(n.ACKS[f][0][u][0]), _(t, h), d(t, a), null !== p && p.write(), 5 === o && t.write(r.from(c)), !0
                            }(e, t, s);
                        case "pingreq":
                        case "pingresp":
                            return function(e, t, r) {
                        ...
                        case "disconnect":
                            return function(e, t, i) {
                                ...
                                let c = 5 === o ? 1 : 0,
                                    l = null;
                                if (5 === o) {
                                    if (!(l = C(t, u, i, c))) return !1;
                                    c += l.length
                                }
                                return t.write(r.from([n.codes.disconnect << 4])), _(t, c), 5 === o && t.write(r.from([a])), null !== l && l.write(), !0
                            }(e, t, s);
                        case "auth":
                            return function(e, t, i) {
                                const o = i ? i.protocolVersion : 4,
                                ...
                                const l = C(t, u, i, c);
                                return !!l && (c += l.length, t.write(r.from([n.codes.auth << 4])), _(t, c), t.write(r.from([a])), null !== l && l.write(), !0)
                            }(e, t, s);
                        default:
                ...
                Object.defineProperty(b, "cacheNumbers", {
                    get: () => d === S,
                    set(e) {
                        e ? (c && 0 !== Object.keys(c).length || (g = !0), d = S) : (g = !1, d = k)
                    }
                });
                const y = {};
                ...
                function _(e, t) {
                    let r = y[t];
                    r || (r = h(t), t < 16384 && (y[t] = r)), u("writeVarByteInt: writing to stream: %o", r), e.write(r)
                }
                        ...
                        case "pair":
                            Object.getOwnPropertyNames(i).forEach((o => {
                                ...
                                Array.isArray(s) ? s.forEach((i => {
                                    e.write(r.from([n.properties[t]])), v(e, o.toString(), i.toString())
                                })) : (e.write(r.from([n.properties[t]])), v(e, o.toString(), s.toString()))
                            }));
                            break;
                        default:
                ...
                function x(e, t, r) {
                    ...
                    for (const r in t)
                        if (Object.prototype.hasOwnProperty.call(t, r) && null !== t[r]) {
                            const n = t[r];
                            if (Array.isArray(n))
                                for (let t = 0; t < n.length; t++) T(e, r, n[t]);
                            else T(e, r, n)
                        }
                }
        ...
        45: [function(e, t, r) {
            (function(e) {
                ! function(n) {
                    ...
                    function k(e, t, r) {
                        var n = 0;
                        for (e = r ? g(e / 700) : e >> 1, e += g(e / t); e > 455; n += l) e = g(e / 35);
                        return g(n + 36 * e / (e + 38))
                    }

                    function E(e) {
                        var t, r, n, i, o, s, a, u, f, h, p, d = [],
                            b = e.length,
                            y = 0,
                            _ = 128,
                            w = 72;
                        ...
                        for (i = r > 0 ? r + 1 : 0; i < b;) {
                            for (o = y, s = 1, a = l; i >= b && m("invalid-input"), ((u = (p = e.charCodeAt(i++)) - 48 < 10 ? p - 22 : p - 65 < 26 ? p - 65 : p - 97 < 26 ? p - 97 : l) >= l || u > g((c - y) / s)) && m("overflow"), y += u * s, !(u < (f = a <= w ? 1 : a >= w + 26 ? 26 : a - w)); a += l) s > g(c / (h = l - f)) && m("overflow"), s *= h;
                            w = k(y - o, t = d.length + 1, 0 == o), g(y / t) > c - _ && m("overflow"), _ += g(y / t), y %= t, d.splice(y++, 0, _)
                        }
                        return v(d)
                    }

                    function I(e) {
                        var t, r, n, i, o, s, a, u, f, h, p, d, y, _, v, E = [];
                        for (d = (e = w(e)).length, t = 128, r = 0, o = 72, s = 0; s < d; ++s)(p = e[s]) < 128 && E.push(b(p));
                        for (n = i = E.length, i && E.push("-"); n < d;) {
                            for (a = c, s = 0; s < d; ++s)(p = e[s]) >= t && p < a && (a = p);
                            for (a - t > g((c - r) / (y = n + 1)) && m("overflow"), r += (a - t) * y, t = a, s = 0; s < d; ++s)
                                if ((p = e[s]) < t && ++r > c && m("overflow"), p == t) {
                                    for (u = r, f = l; !(u < (h = f <= o ? 1 : f >= o + 26 ? 26 : f - o)); f += l) v = u - h, _ = l - h, E.push(b(S(h + v % _, 0))), u = g(v / _);
                                    E.push(b(S(u, 0))), o = k(r, y, n == i), r = 0, ++n
                                }++r, ++t
                        }
                        return E.join("")
                    }
        ...
        52: [function(e, t, r) {
            (function(r, n) {
                "use strict";
                var i;
                t.exports = I, I.ReadableState = E, e("events").EventEmitter;
                ...
                var f, h, p, d = e("./internal/streams/buffer_list"),
                    g = e("./internal/streams/destroy"),
                    b = e("./internal/streams/state").getHighWaterMark,
                    m = e("../errors").codes,
                    y = m.ERR_INVALID_ARG_TYPE,
                    _ = m.ERR_STREAM_PUSH_AFTER_EOF,
                ...
                function I(t) {
                    if (i = i || e("./_stream_duplex"), !(this instanceof I)) return new I(t);
                    var r = this instanceof i;
                    this._readableState = new E(t, this, r), this.readable = !0, t && ("function" == typeof t.read && (this._read = t.read), "function" == typeof t.destroy && (this._destroy = t.destroy)), a.call(this)
                }
                ...
                function C(e, t, r, n, i) {
                    ...
                    if (null === t) a.reading = !1,
                        ...
                        if ("string" == typeof t || a.objectMode || Object.getPrototypeOf(t) === u.prototype || (t = function(e) {
                                return u.from(e)
                            }(t)), n) a.endEmitted ? S(e, new v) : T(e, a, t, !0);
                        else if (a.ended) S(e, new _);
                    else {
                        if (a.destroyed) return !1;
                        a.reading = !1, a.decoder && !r ? (t = a.decoder.write(t), a.objectMode || 0 !== t.length ? T(e, a, t, !1) : O(e, a)) : T(e, a, t, !1)
                ...
                }), I.prototype.destroy = g.destroy, I.prototype._undestroy = g.undestroy, I.prototype._destroy = function(e, t) {
                    t(e)
                }, I.prototype.push = function(e, t) {
                    var r, n = this._readableState;
                    return n.objectMode ? r = !0 : "string" == typeof e && ((t = t || n.defaultEncoding) !== n.encoding && (e = u.from(e, t), t = ""), r = !0), C(this, e, t, !1, r)
                ...
                function A(e) {
                    var t = e._readableState;
                    o("emitReadable", t.needReadable, t.emittedReadable), t.needReadable = !1, t.emittedReadable || (o("emitReadable", t.flowing), t.emittedReadable = !0, r.nextTick(M, e))
                }
                ...
                function q(e) {
                    var t = e._readableState;
                    o("endReadable", t.endEmitted), t.endEmitted || (t.ended = !0, r.nextTick(D, t, e))
                }
                ...
                I.prototype.read = function(e) {
                    ...
                    var t = this._readableState,
                        r = e;
                    if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && ((0 !== t.highWaterMark ? t.length >= t.highWaterMark : t.length > 0) || t.ended)) return o("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? q(this) : A(this), null;
                    if (0 === (e = R(e, t)) && t.ended) return 0 === t.length && q(this), null;
                    var n, i = t.needReadable;
                    ...
                    var a = t && !1 === t.end || e === r.stdout || e === r.stderr ? g : u;
                    ...
                    function h(t) {
                        o("onerror", t), g(), e.removeListener("error", h), 0 === s(e, "error") && S(e, t)
                    }
                    ...
                    function d() {
                        o("onfinish"), e.removeListener("close", p), g()
                    }
                    ...
                    return n.on("data", f),
                        ...
                        }(e, "error", h), e.once("close", p), e.once("finish", d), e.emit("pipe", n), i.flowing || (o("pipe resume"), n.resume()), e
                    ...
                    var n = a.prototype.on.call(this, e, t),
                        i = this._readableState;
                    return "data" === e ? (i.readableListening = this.listenerCount("readable") > 0, !1 !== i.flowing && this.resume()) : "readable" === e && (i.endEmitted || i.readableListening || (i.readableListening = i.needReadable = !0, i.flowing = !1, i.emittedReadable = !1, o("on readable", i.length, i.reading), i.length ? A(this) : i.reading || r.nextTick(B, this))), n
                ...
                }), I._fromList = N, Object.defineProperty(I.prototype, "readableLength", {
                    enumerable: !1,
                    get: function() {
                        return this._readableState.length
                    }
                }), "function" == typeof Symbol && (I.from = function(t, r) {
                    return void 0 === p && (p = e("./internal/streams/from")), p(I, t, r)
                })
            }).call(this, e("_process"), "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {
            "../errors": 49,
            "./_stream_duplex": 50,
            "./internal/streams/async_iterator": 55,
            "./internal/streams/buffer_list": 56,
            "./internal/streams/destroy": 57,
            "./internal/streams/from": 59,
            "./internal/streams/state": 61,
            "./internal/streams/stream": 62,
            _process: 44,
            buffer: 12,
            events: 27,
            inherits: 29,
        ...
        54: [function(e, t, r) {
            (function(r, n) {
                ...
                function E(t, n, s) {
                    o = o || e("./_stream_duplex"), t = t || {}, "boolean" != typeof s && (s = n instanceof o), this.objectMode = !!t.objectMode, s && (this.objectMode = this.objectMode || !!t.writableObjectMode), this.highWaterMark = h(this, t, "writableHighWaterMark", s), this.finalCalled = !1, this.needDrain = !1, this.ending = !1, this.ended = !1, this.finished = !1, this.destroyed = !1;
                    ...
                    this.decodeStrings = !a, this.defaultEncoding = t.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function(e) {
                        ! function(e, t) {
                            ...
                            if (function(e) {
                                ...
                                --t.pendingcb, n ? (r.nextTick(o, i), r.nextTick(M, e, t), e._writableState.errorEmitted = !0, S(e, i)) : (o(i), e._writableState.errorEmitted = !0, S(e, i), M(e, t))
                            }(e, n, i, t, o);
                            else {
                                var s = R(n) || e.destroyed;
                                s || n.corked || n.bufferProcessing || !n.bufferedRequest || x(e, n), i ? r.nextTick(T, e, n, s, o) : T(e, n, s, o)
                            }
                        }(n, e)
                ...
                function I(t) {
                    ...
                    if (!r && !s.call(I, this)) return new I(t);
                    this._writableState = new E(t, this, r), this.writable = !0, t && ("function" == typeof t.write && (this._write = t.write), "function" == typeof t.writev && (this._writev = t.writev), "function" == typeof t.destroy && (this._destroy = t.destroy), "function" == typeof t.final && (this._final = t.final)), u.call(this)
                }
                ...
                function x(e, t) {
                    ...
                    if (e._writev && r && r.next) {
                        ...
                        o.allBuffers = u, C(e, t, !0, t.length, o, "", s.finish), t.pendingcb++, t.lastBufferedRequest = null, s.next ? (t.corkedRequestsFree = s.next, s.next = null) : t.corkedRequestsFree = new i(t), t.bufferedRequestCount = 0
                    } else {
                        for (; r;) {
                            var c = r.chunk,
                                l = r.encoding,
                                f = r.callback;
                            if (C(e, t, !1, t.objectMode ? 1 : c.length, c, l, f), r = r.next, t.bufferedRequestCount--, t.writing) break
                        }
                        null === r && (t.lastBufferedRequest = null)
                    }
                    t.bufferedRequest = r, t.bufferProcessing = !1
                ...
                e("inherits")(I, u), E.prototype.getBuffer = function() {
                        for (var e = this.bufferedRequest, t = []; e;) t.push(e), e = e.next;
                        return t
                    },
                    function() {
                    ...
                    }(), "function" == typeof Symbol && Symbol.hasInstance && "function" == typeof Function.prototype[Symbol.hasInstance] ? (s = Function.prototype[Symbol.hasInstance], Object.defineProperty(I, Symbol.hasInstance, {
                        value: function(e) {
                            return !!s.call(this, e) || this === I && e && e._writableState instanceof E
                        }
                    })) : s = function(e) {
                        return e instanceof this
                        ...
                        return a && !c.isBuffer(e) && (e = function(e) {
                            return c.from(e)
                        }(e)), "function" == typeof t && (n = t, t = null), a ? t = "buffer" : t || (t = o.defaultEncoding), "function" != typeof n && (n = k), o.ending ? function(e, t) {
                            var n = new w;
                            S(e, n), r.nextTick(t, n)
                        }(this, n) : (a || function(e, t, n, i) {
                            var o;
                            return null === n ? o = new _ : "string" == typeof n || t.objectMode || (o = new d("chunk", ["string", "Buffer"], n)), !o || (S(e, o), r.nextTick(i, o), !1)
                        ...
                        return "function" == typeof e ? (n = e, e = null, t = null) : "function" == typeof t && (n = t, t = null), null != e && this.write(e, t), i.corked && (i.corked = 1, this.uncork()), i.ending || function(e, t, n) {
                            t.ending = !0, M(e, t), n && (t.finished ? r.nextTick(n) : e.once("finish", n)), t.ended = !0, e.writable = !1
                        }(this, i, n), this
                    ...
                    }), I.prototype.destroy = f.destroy, I.prototype._undestroy = f.undestroy, I.prototype._destroy = function(e, t) {
                        t(e)
                    }
            }).call(this, e("_process"), "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {
            ...
            t.exports = function() {
                ...
                return (t = [{
                    ...
                    value: function(e) {
                        ...
                        for (var t, r, n, i = o.allocUnsafe(e >>> 0), s = this.head, a = 0; s;) t = s.data, r = i, n = a, o.prototype.copy.call(t, r, n), a += s.data.length, s = s.next;
                        return i
                    }
                }, {
                    key: "consume",
        ...
        58: [function(e, t, r) {
            ...
            t.exports = function e(t, r, o) {
                ...
                return function(e) {
                        return e.setHeader && "function" == typeof e.abort
                    }(t) ? (t.on("complete", l), t.on("abort", d), t.req ? g() : t.on("request", g)) : a && !t._writableState && (t.on("end", u), t.on("close", u)), t.on("end", h), t.on("finish", l), !1 !== r.error && t.on("error", p), t.on("close", d),
                    function() {
                        t.removeListener("complete", l), t.removeListener("abort", d), t.removeListener("request", g), t.req && t.req.removeListener("finish", l), t.removeListener("end", u), t.removeListener("close", u), t.removeListener("finish", l), t.removeListener("end", h), t.removeListener("error", p), t.removeListener("close", d)
                    }
            }
        }, {
            "../../../errors": 49
        ...
        63: [function(e, t, r) {
            ...
            "./lib/internal/streams/end-of-stream.js": 58,
            "./lib/internal/streams/pipeline.js": 60
        }],
        64: [function(e, t, r) {
            "use strict";
            t.exports = function() {
        ...
        69: [function(e, t, r) {
            ...
            r.parse = _, r.resolve = function(e, t) {
                ...
                return i.isString(e) && (e = _(e)), e instanceof o ? e.format() : o.prototype.format.call(e)
            }, r.Url = o;
            var s = /^([a-z0-9.+-]+:)/i,
                a = /:[0-9]*$/,
                u = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/,
            ...
            o.prototype.parse = function(e, t, r) {
                ...
                if (_ = _.trim(), !r && 1 === e.split("#").length) {
                    var w = u.exec(_);
                    if (w) return this.path = _, this.href = _, this.pathname = w[1], w[2] ? (this.search = w[2], this.query = t ? y.parse(this.search.substr(1)) : this.search.substr(1)) : t && (this.search = "", this.query = {}), this
                }
                var v = s.exec(_);
                if (v) {
                    var S = (v = v[0]).toLowerCase();
                    this.protocol = S, _ = _.substr(v.length)
                }
                if (r || v || _.match(/^\/\/[^@\/]+@[^@\/]+/)) {
                    var k = "//" === _.substr(0, 2);
                    !k || v && b[v] || (_ = _.substr(2), this.slashes = !0)
                }
                if (!b[v] && (k || v && !m[v])) {
                    for (var E, I, C = -1, T = 0; T < h.length; T++) - 1 !== (x = _.indexOf(h[T])) && (-1 === C || x < C) && (C = x);
                    for (-1 !== (I = -1 === C ? _.lastIndexOf("@") : _.lastIndexOf("@", C)) && (E = _.slice(0, I), _ = _.slice(I + 1), this.auth = decodeURIComponent(E)), C = -1, T = 0; T < f.length; T++) {
                        var x; - 1 !== (x = _.indexOf(f[T])) && (-1 === C || x < C) && (C = x)
                    } - 1 === C && (C = _.length), this.host = _.slice(0, C), _ = _.slice(C), this.parseHost(), this.hostname = this.hostname || "";
                    var R = "[" === this.hostname[0] && "]" === this.hostname[this.hostname.length - 1];
                    if (!R)
                        for (var A = this.hostname.split(/\./), M = (T = 0, A.length); T < M; T++) {
                            var O = A[T];
                            if (O && !O.match(p)) {
                                for (var P = "", L = 0, B = O.length; L < B; L++) O.charCodeAt(L) > 127 ? P += "x" : P += O[L];
                                if (!P.match(p)) {
                                    var j = A.slice(0, T),
                                        U = A.slice(T + 1),
                                        N = O.match(d);
                                    N && (j.push(N[1]), U.unshift(N[2])), U.length && (_ = "/" + U.join(".") + _), this.hostname = j.join(".");
                                    break
                                }
                            }
                        }
                    ...
                    var q = this.port ? ":" + this.port : "",
                        D = this.hostname || "";
                    this.host = D + q, this.href += this.host, R && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== _[0] && (_ = "/" + _))
                }
                if (!g[S])
                    for (T = 0, M = l.length; T < M; T++) {
                        var F = l[T];
                        if (-1 !== _.indexOf(F)) {
                            var W = encodeURIComponent(F);
                            W === F && (W = escape(F)), _ = _.split(F).join(W)
                        }
                    }
                var H = _.indexOf("#"); - 1 !== H && (this.hash = _.substr(H), _ = _.slice(0, H));
                var V = _.indexOf("?");
                if (-1 !== V ? (this.search = _.substr(V), this.query = _.substr(V + 1), t && (this.query = y.parse(this.query)), _ = _.slice(0, V)) : t && (this.search = "", this.query = {}), _ && (this.pathname = _), m[S] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
                    q = this.pathname || "";
                    var K = this.search || "";
                    this.path = q + K
                }
                ...
                var _ = r.pathname && "/" === r.pathname.charAt(0),
                    ...
                    v = w || _ || r.host && e.pathname,
                    S = v,
                    k = r.pathname && r.pathname.split("/") || [],
                    E = (d = e.pathname && e.pathname.split("/") || [], r.protocol && !m[r.protocol]);
                if (E && (r.hostname = "", r.port = null, r.host && ("" === k[0] ? k[0] = r.host : k.unshift(r.host)), r.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === d[0] ? d[0] = e.host : d.unshift(e.host)), e.host = null), v = v && ("" === d[0] || "" === k[0])), w) r.host = e.host || "" === e.host ? e.host : r.host, r.hostname = e.hostname || "" === e.hostname ? e.hostname : r.hostname, r.search = e.search, r.query = e.query, k = d;
                else if (d.length) k || (k = []), k.pop(), k = k.concat(d), r.search = e.search, r.query = e.query;
                else if (!i.isNullOrUndefined(e.search)) return E && (r.hostname = r.host = k.shift(), (R = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = R.shift(), r.host = r.hostname = R.shift())), r.search = e.search, r.query = e.query, i.isNull(r.pathname) && i.isNull(r.search) || (r.path = (r.pathname ? r.pathname : "") + (r.search ? r.search : "")), r.href = r.format(), r;
                if (!k.length) return r.pathname = null, r.search ? r.path = "/" + r.search : r.path = null, r.href = r.format(), r;
                for (var I = k.slice(-1)[0], C = (r.host || e.host || k.length > 1) && ("." === I || ".." === I) || "" === I, T = 0, x = k.length; x >= 0; x--) "." === (I = k[x]) ? k.splice(x, 1) : ".." === I ? (k.splice(x, 1), T++) : T && (k.splice(x, 1), T--);
                if (!v && !S)
                    for (; T--; T) k.unshift("..");
                !v || "" === k[0] || k[0] && "/" === k[0].charAt(0) || k.unshift(""), C && "/" !== k.join("/").substr(-1) && k.push("");
                var R, A = "" === k[0] || k[0] && "/" === k[0].charAt(0);
                return E && (r.hostname = r.host = A ? "" : k.length ? k.shift() : "", (R = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = R.shift(), r.host = r.hostname = R.shift())), (v = v || r.host && k.length) && !A && k.unshift(""), k.length ? r.pathname = k.join("/") : (r.pathname = null, r.path = null), i.isNull(r.pathname) && i.isNull(r.search) || (r.path = (r.pathname ? r.pathname : "") + (r.search ? r.search : "")), r.auth = e.auth || r.auth, r.slashes = r.slashes || e.slashes, r.href = r.format(), r
